	...
	<div class="manage tc">
		...
		<div class="wrap" v-show="showEdit">
			<div class="content">
				...
				<button v-on:click="cancleEdit">取消</button>
...
<style>
	...
	.manage >button {  /*这个button前的>是什么意思？只对当前这个作用吗*/
		width:200px; 
		height:40px; 
		line-height:40px; 
	...
	export default {
		...
		methods: {
			...
			edit(e) {
				...
				this.showEdit = true
				this.editId = id
				this.newName = this.persons[id].name
			},
			...
			editName() {
				...
				if(v.trim() == ""){
					...
					this.persons[this.editId].name = this.newName
					this.showEdit = false
				}
			}
		}
